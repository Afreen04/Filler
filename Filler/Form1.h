...
char arr[100][10000]={"? is running in the !.","? is dancing on the !.","? is watching a !.","? is bathing a !.","? is singing with a !."};
int val;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->richTextBox1->Location = System::Drawing::Point(56, 37);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(266, 262);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(142, 60);
			...
			this->ClientSize = System::Drawing::Size(491, 434);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 val=pullout(5);
				 richTextBox1->Clear();
				 String^ temp=System::Runtime::InteropServices::Marshal::PtrToStringAnsi(IntPtr((arr[val])));
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 String^ temp=System::Runtime::InteropServices::Marshal::PtrToStringAnsi(IntPtr((fill(arr[val]))));
		       richTextBox1->AppendText(temp);
			    laugh();
			 }
	};
